...
namespace Home_Automation__RPi2_WinIoT_.Pages
{
    ...
    public sealed partial class Page_Configuration : Page
    {
        ...
        {
            LB_Rooms.Items.Add("MyRoom 1");
            LB_Rooms.Items.Add("MyRoom 2");
            LB_Rooms.Items.Add("MyRoom 3");
            LB_Rooms.Items.Add("MyRoom 4");

            LB_Devices.Items.Add("Device 1");
            LB_Devices.Items.Add("Device 2");
            LB_Devices.Items.Add("Device 3");
            LB_Devices.Items.Add("Device 4");
        }
